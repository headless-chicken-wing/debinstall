...
export DEBIAN_ONLINE_INSTALL=true

source /dev/stdin <<<$(curl -fsSL https://raw.githubusercontent.com/headless-chicken-wing/debinstall/refs/heads/main/functions/functions.func)
...
DEBIAN_REF="${DEBIAN_REF:-master}"

# Set mirror based on branch
if [[ $DEBIAN_REF == "dev" ]]; then
  export DEBIAN_MIRROR=edge
  echo 'Server = https://mirror.debinstall.org/$repo/os/$arch' | sudo tee /etc//mirrorlist >/dev/null
